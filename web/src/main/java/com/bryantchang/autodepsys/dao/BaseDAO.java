...
public class BaseDAO {
	...
	private String getDeleteSql(Class cl, Map<String, Object> conditions) {
		String sql = "";
		String baseSqlStr = "delete from " + cl.getSimpleName().toLowerCase() + " where ";
		String conditionStr = "";
		Set keys = conditions.keySet();
		Iterator iterator = keys.iterator();
		while(iterator.hasNext()) {
...
//		NodesSettings settings = new NodesSettings(0L, "test1", "content1", ctime, "127.0.0.1");
//		boolean res = dao.insert(settings);
//		
