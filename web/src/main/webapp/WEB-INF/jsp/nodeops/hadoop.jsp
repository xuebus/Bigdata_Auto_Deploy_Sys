                ...
                <td><c:if test="${hadoopnode['namenode'] == true}">
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="divider"></li>
                      <li><a data-toggle="modal" href="#view_namenode_${hadoopnode['id']}_modal"><i class="icon-search"></i>查看日志</a></li>
                      <li class="divider"></li>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="divider"></li>
                      <li><a data-toggle="modal" href="#view_datanode_${hadoopnode['id']}_modal"><i class="icon-search"></i>查看日志</a></li>
                      <li class="divider"></li>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="divider"></li>
                      <li><a data-toggle="modal" href="#view_secondarynamenode_${hadoopnode['id']}_modal"><i class="icon-search"></i><?php echo $common_view_logs;?></a></li>
                      <li class="divider"></li>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="divider"></li>
                      <li><a data-toggle="modal" href="#view_resourcemanager_${hadoopnode['id']}_modal"><i class="icon-search"></i>查看日志</a></li>
                      <li class="divider"></li>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="divider"></li>
                      <li><a data-toggle="modal" href="#view_nodemanager_${hadoopnode['id']}_modal"><i class="icon-search"></i>查看日志</a></li>
                      <li class="divider"></li>
